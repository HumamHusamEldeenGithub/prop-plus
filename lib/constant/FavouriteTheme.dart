...
class FavouriteTheme{
  static Radius borderRadius = Radius.circular(8);
  static const double trendingPadding = 10.0 ;
  static TextStyle titleTextStyle = TextStyle(color: MainTheme.mainFontColor, fontSize: MainTheme.fontMedium, fontWeight: FontWeight.w600);
